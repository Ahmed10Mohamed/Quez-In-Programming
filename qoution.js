...
$("#btn1").click(function () {
    ...
    $("#btn4").click(function () {
    //Cash The Variables
   var ans1=($("input:radio[name=ans1]:checked").val()),
        ans2=($("input:radio[name=ans2]:checked").val()),
        ans3=($("input:radio[name=ans3]:checked").val()),
        ans4=($("input:radio[name=ans4]:checked").val()),
       result=0,
       show=$("#study");
        //******************************************************************
